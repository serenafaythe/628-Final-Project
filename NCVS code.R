...
ncvs <- all_ncvs|>
  select("month" = V3025, "day" = V3026, "year" = V3027, "age" = V3014, 
         ...
         "rape_verbal_threat" = V4078, "sex_assualt_verbal_threat" =  V4081, 
         "sex_contact_force" = V4082, "sex_contact_no_force" = V4083, 
         "raped" = V4094, "attempted_rape" = V4095, "sexual_assault" = V4096,
         "rape_injuries" = V4112, "attempted_rape_injury" = V4113,
         "sex_assault_injury" = V4114, "activity" = V4478, 
         "offender_sex" = V4236, "offender_age" = V4237,
         ...
         "how_reported" = V4400, "reason_not_rptd_proof" = V4410,
         "reason_not_rptd_protect" = V4415, "reason_not_rptd_advised" = V4416,
         "reason_not_rptd_reprisal" = V4417, "reason_not_rptd" = V4422,
...
ggplot(ncvs_race, aes(x= reorder(race, desc(percentage)), y=percentage))+
...
mean(ncvs_yearly$percentage_sv_reported)
...
age_report <- ncvs|>
  ...
  rename("Yes" = "1",
         ...
         "DK" = "3",
         "Residue" = "8")|>
  mutate(percent = Yes/(Yes+No+DK + Residue))

age_report_sv <- ncvs_sv|>
  group_by(age5)|>
  count(reported)|>
  pivot_wider(names_from = reported, values_from = n)|>
  select("1", "2")|>
